...
> **Screenshots:** Add 1–2 images under `docs/images/` (for example `mindmap-overview.png`) before submitting to the community directory. Obsidian reviewers and users rely on visuals in the README.
